...
- **Source** và **Sink** thường được sử dụng để **taint analysist** (phân tích sự nhiễm độc - tôi ko thích cách dịch này lắm). Đọc thêm về **taint analysist**: [https://owasp.org/www-community/controls/Static_Code_Analysis#Taint_Analysis](https://owasp.org/www-community/controls/Static_Code_Analysis#Taint_Analysis)
